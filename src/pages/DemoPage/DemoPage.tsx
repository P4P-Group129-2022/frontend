...
function DemoPage() {
    ...
    const {showNotification, showNotificationByName} = useNotifications();
    ...
    return (
        <AppWindowFrame frameColor={"#270C29"} title={"Demo Page"}>
            ...
            <Button variant="outlined" onClick={() => {
                ...
                launch dummy notification.
            </Button>

            <Button variant="outlined" onClick={() => {
                showNotificationByName("test");
            }}>
                launch notification from backend.
            </Button>
        </AppWindowFrame>
    );
}
